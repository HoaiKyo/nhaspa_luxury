...
-- 19. HOA_DON (20)
INSERT INTO hoa_don (ma_lich_hen, ma_khach_hang, ma_nhan_vien, tong_tien, giam_gia, thue, thanh_tien, trang_thai, diem_tich_luy) VALUES
(7,13,2,400000,0,32000,432000,'PAID',43),(8,14,2,1200000,120000,86400,1166400,'PAID',116),
(1,5,3,400000,40000,28800,388800,'PAID',38),(2,8,4,1250000,0,100000,1350000,'PENDING',0),
(3,9,3,200000,0,16000,216000,'PAID',21),(4,10,4,950000,95000,68400,923400,'PAID',92),
(5,11,13,400000,0,32000,432000,'PAID',43),(6,12,4,850000,50000,64000,864000,'PARTIAL',0),
(NULL,15,2,600000,0,48000,648000,'PAID',64),(NULL,16,2,300000,30000,21600,291600,'PAID',29),
(NULL,17,2,800000,0,64000,864000,'DRAFT',0),(NULL,18,2,450000,0,36000,486000,'PAID',48),
(NULL,19,2,250000,0,20000,270000,'PAID',27),(NULL,20,2,900000,90000,64800,874800,'PAID',87),
(NULL,5,3,700000,70000,50400,680400,'PAID',68),(NULL,8,4,1800000,180000,129600,1749600,'PAID',174),
(NULL,9,3,400000,0,32000,432000,'CANCELLED',0),(NULL,10,4,600000,0,48000,648000,'PAID',64),
(NULL,11,13,350000,0,28000,378000,'PAID',37),(NULL,13,2,500000,0,40000,540000,'PENDING',0);
GO
